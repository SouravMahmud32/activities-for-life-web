        ...
        <div className='cart'>
            ...
            <div>
                ...
                <div className="break-time">
                    <div onClick={() => {setBreakTime(20)}}>
                        <p>20<small>s</small></p>
                    </div>
                    <div  onClick={() => {setBreakTime(30)}}>
                        <p>30<small>s</small></p>
                    </div>
                    <div  onClick={() => {setBreakTime(40)}}>
                        <p>40<small>s</small></p>
                    </div>
                    <div onClick={() => {setBreakTime(50)}}>
